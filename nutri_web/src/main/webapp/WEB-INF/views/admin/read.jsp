...
<div class="row">
  <div class="col-lg-12">
    <h1 class="page-header">market_board Read</h1>
  </div>
  <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
...
<div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-heading">market_board Read Page</div>
      <!-- /.panel-heading -->
      <div class="panel-body">

         <div class="form-group">
           <label>m_no</label> <input class="form-control" name="m_no" value="${market_board.m_no }" readonly="readonly">
         </div>

         <div class="form-group">
           <label>Title</label> <input class="form-control" name="m_title" value="${market_board.m_title }" readonly="readonly">
         </div>
         ...
         <div class="form-group">
           <label>Writer</label> <input class="form-control" name="m_writer" value="${market_board.m_writer }" readonly="readonly">
         </div>
