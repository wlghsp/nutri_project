...
<div class="container">
  <h4>회원에게 메일 보내기</h4>
  <form action="${contextPath}/admin/mailSending" method="post">
  	<div align="center"><!-- 제목 -->
      <input type="email" name="userEmail"  size="120" style="width:100%" value="${email }" class="form-control" readonly="readonly" >
    </div>
    <div align="center"><!-- 제목 -->
