...
<div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
	  ...
	  <form action="${contextPath}/market_board/modify" method="post" role="form">
         ...
         <div class="form-group">
           <label>제 목</label> <input class="form-control" name="m_title" value="${market_board.m_title }">
         </div>

         <div class="form-group">
           <label>내 용</label>
           <textarea class="form-control" rows="3" name="m_content">${market_board.m_content }</textarea>
         </div>
...
$(document).ready(function() {
	...
	$("button").on("click", function(e) {
		...
		if(operation === "remove") {
			formObj.attr("action", "${contextPath}/market_board/remove");
		} else if(operation === "list") {
			//move to list
			formObj.attr("action", "${contextPath}/market_board/list").attr("method","get");
			...
			//self.location = "${contextPath}/market_board/list";
